...
def _update_relative_errorbars(t, avg_rsb, sem_rsb, error_obj, error_obj_stim):
...
def gen_t_slider_callback(
    ...
    def t_slider_callback(t):
        # Update the errobars
        _update_relative_errorbars(
            t, avg_rsb, sem_rsb, error_obj, error_obj_stim
        )
