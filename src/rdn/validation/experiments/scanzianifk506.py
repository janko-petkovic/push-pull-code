...
def scanziani_mc(model, model_p_dict):
    ...
    ax.errorbar(x_post, y_unstim, yerr=yerr_unstim, fmt=".")
    ax.errorbar(x_pre, y_pre, fmt=".", c="tab:blue", label="stim")
    ...
    plt.savefig(
        "/home/janko/code/phd/rdn-project/docs/paper/src/figures/results/sim_scanziani_mc.png"
    )
